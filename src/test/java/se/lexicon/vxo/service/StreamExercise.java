...
public class StreamExercise {
    ...
    public void task10() {
        ...
        optional = people.stream().filter(person -> person.getPersonId() == 5914)
    ...
    public void task12() {
        ...
        String[] result = null;
        Predicate<Person> palindromeName= person -> {
        ...
        result = people.stream().filter(palindromeName).map(person -> person.getFirstName()).sorted().distinct().toArray(String[]::new);
    ...
    public void task14() {
        ...
        _2020_dates = Stream.iterate(LocalDate.parse("2020-01-01"), date -> date.plusDays(1)).limit(366).toArray(LocalDate[]::new);
